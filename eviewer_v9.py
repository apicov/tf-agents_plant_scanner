...
import dqnn_360_tools as nntools
imp.reload(nntools)
...
def get_images(images_path):
    ...
    for i in files:
        ...
        img = pygame.transform.scale(img, (300, 168))
...
class policySim():
    ...
    def move(self,position):
        self.screen.blit(self.background, (0, 0))
        self.screen.blit(self.imgs[position], (170, 236))
...
mi = '/home/pico/romi/scan_1440_2/real_plant001/v03/'
m_idxs = [mi+'inliers_ratios.npy']
envs = [romi_env.RomiEnv(env) for env in m_idxs]

imgs = get_images(mi+'imgs/')

#mpath = '/home/pico/romi/scan_1440/models/6_4_10000/'
mpath = '/home/pico/romi/scan_1440_2/models/idx03_50k/'
model = read_model(mpath,0)#0
#model = read_model_n(mpath,'v7_30')#0
...
scaler =  nntools.MinMaxScaler(scale=(-1,1),mins=[0,-200,0,0,-1.0,-20,0]*time_steps,maxs=[1.0,200,36,10,1.0,20,1]*time_steps)
